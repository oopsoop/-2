        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input type="text" class="form-control" name="proj_name" id="proj_name"  placeholder="项目名称" value="@if(!empty(old('proj_name'))){{old('proj_name')}}@else{{$corp['proj_name']}}@endif">
             ...
             {{--<div class="row">--}}
                {{--<div class="col-xs-12 form-group">--}}
                    ...
                    {{--<input type="text" class="form-control" name="proj_type" id="proj_type"  placeholder="项目类别" value="@if(!empty(old('proj_type'))){{old('proj_type')}}@else{{$corp['proj_type']}}@endif">--}}
            ...
            {{--</div>--}}
             ...
             <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input disabled type="text" class="form-control" name="projapply_time" id="projapply_time"   placeholder="申报时间" value="@if(!empty(old('created_at'))){{old('created_at')}}@else{{$corp['created_at']}}@endif">
             ...
             <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input type="text" class="form-control" name="company_info" id="company_info"  placeholder="企业信息" value="@if(!empty(old('company_info'))){{old('company_info')}}@else{{$corp['company_info']}}@endif">
             ...
             <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input type="text" class="form-control" name="remarks" id="remarks"  placeholder="备注" value="@if(!empty(old('remarks'))){{old('remarks')}}@else{{$corp['remarks']}}@endif">
