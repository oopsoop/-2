        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <?php foreach($stadiumDatas as $k=>$tag):
                        if($corp['stadium_id'] == $tag){
                            $selected = 'selected="selected"';
                        }else{
                            $selected = '';
                        }
                    ?>
                        <option <?php echo $selected; ?> value = '<?php echo $tag;?>'><?php echo $k; ?></option>
                        <?php endforeach;?>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    ?>
                        <option <?php echo $selected; ?> value = '<?php echo $tag1;?>'><?php echo $k1; ?></option>
                        <?php endforeach;?>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                   ...
                   <input type="text" class="form-control" name="default_num" id="default_num"  placeholder="默认人数" value="@if(!empty(old('default_num'))){{old('default_num')}}@else{{$corp['default_num']}}@endif">
             ...
             <div class="row">
                <div class="col-xs-12 form-group">
                   ...
                   <input type="text" class="form-control" name="period" id="period"  placeholder="时间间隔设置" value="@if(!empty(old('period'))){{old('period')}}@else{{$corp['period']}}@endif">
            ...
            {{--<div class="row">--}}
                {{--<div class="col-xs-12 form-group">--}}
                   ...
                   {{--<input type="text" class="form-control" name="started_at" id="started_at"  placeholder="课程开始时间" value="@if(!empty(old('started_at'))){{old('started_at')}}@else{{$corp['started_at']}}@endif">--}}
            ...
            {{--</div>--}}
             {{--<div class="row">--}}
                {{--<div class="col-xs-12 form-group">--}}
                   ...
                   {{--<input type="text" class="form-control" name="end_at" id="end_at"  placeholder="课程结束时间" value="@if(!empty(old('end_at'))){{old('end_at')}}@else{{$corp['end_at']}}@endif">--}}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <?php foreach($xis as $k=>$status_id):
                        if($corp['status_id'] == $status_id){
                            $selected = 'selected="selected"';
                        }else{
                            $selected = '';
                        }
                        ?>
                        <option <?php echo $selected; ?>  value = '<?php echo $status_id;?>'><?php echo $k; ?></option>
                        <?php endforeach;?>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <?php foreach($course_grades as $k=>$course_grade):
                        if($corp['course_grade'] == $course_grade){
                            $selected = 'selected="selected"';
                        }else{
                            $selected = '';
                        }
                    ?>
                        <option <?php echo $selected; ?>  value = '<?php echo $course_grade;?>'><?php echo $k; ?></option>
                        <?php endforeach;?>
             ...
             <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <?php foreach($is_setups as $k=>$is_setup):
                        if($corp['is_setup'] == $is_setup){
                            $selected = 'selected="selected"';
                        }else{
                            $selected = '';
                        }
                        ?>
                        <option <?php echo $selected; ?>  value = '<?php echo $is_setup;?>'><?php echo $k; ?></option>
                        <?php endforeach;?>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                   ...
                   <textarea name = "course_explain" id = "course_explain" class="form-control" cols = "30" rows = "4">@if(!empty(old('course_explain'))){{old('course_explain')}}@else{{$corp['course_explain']}}@endif</textarea>
                   <p class="help-block"></p>
