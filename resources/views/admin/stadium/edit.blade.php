        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    <label for="stadium_name" class="control-label">场馆名称</label>
                    <input type="text" class="form-control" name="stadium_name" id="stadium_name"  placeholder="场馆名称" value="@if(!empty(old('stadium_name'))){{old('stadium_name')}}@else{{$corp['stadium_name']}}@endif">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    <label for="district" class="control-label">地址</label>
                    <input type="text" class="form-control" name="district" id="district"  placeholder="地址" value="@if(!empty(old('district'))){{old('district')}}@else{{$corp['district']}}@endif">
             ...
             <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input type="text" class="form-control" name="latitude" id="latitude"  placeholder="纬度" value="@if(!empty(old('latitude'))){{old('latitude')}}@else{{$corp['latitude']}}@endif">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input type="text" class="form-control" name="longitude" id="longitude"  placeholder="经度" value="@if(!empty(old('longitude'))){{old('longitude')}}@else{{$corp['longitude']}}@endif">
             ...
             <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input type="text" class="form-control" name="distance" id="distance"  placeholder="设置范围" value="@if(!empty(old('distance'))){{old('distance')}}@else{{$corp['distance']}}@endif">
            ...
            {{--<div class="row">--}}
                {{--<div class="col-xs-12 form-group">--}}
                    ...
                    {{--<input type="text" class="form-control" name="search_addr" id="search_addr"  placeholder="搜索地址" value="@if(!empty(old('search_addr'))){{old('search_addr')}}@else{{$corp['search_addr']}}@endif">--}}
            ...
            {{--<div class="col-md-1-5 form-group" style="padding-left: 0px">--}}
                   ...
                   {{--<input  type="file" name="" data-icon="false" data-classbutton="btn btn-default" data-classinput="form-control inline v-middle input-s" id="pic_student_abroad" tabindex="-1" style="position: absolute; clip: rect(0px 0px 0px 0px);"><div class="bootstrap-filestyle input-group"><input type="text" class="form-control" name="pic_student_abroad" value="" id="photoCover-pic_student_abroad" readonly> <span class="group-span-filestyle input-group-btn" tabindex="0"><label for="pic_student_abroad" class="btn btn-default "><span class="glyphicon glyphicon-folder-open"></span>  上传导览图</label></span></div>--}}
                    {{--<div id="photoCoverimg-pic_student_abroad">--}}
                            ...
                            {{--<img src="@if(!empty($corp['stadium_pic'])){{$corp['stadium_pic']}}@else{{Storage::url(ord('stadium_pic'))}}@endif"  class="img-responsive gonggongyasd" alt="Responsive image" style="margin-top:10px;width: 90px">--}}
                ...
                <div class="col-xs-12 form-group" >
                    ...
                    <div class="fileinput fileinput-exists " data-provides="fileinput" id="exampleInputUpload" style="vertical-align: middle">
                            ...
                            <div id="uploadpic" class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 10px;">
                                <img src = "@if(!empty(old('stadium_pic'))){{old('stadium_pic')}}@else{{$corp['stadium_pic']}}@endif" alt = "">
                            </div>
                            <div>
                                <span class="btn btn-primary btn-file">
                                    <span class="fileinput-new">选择图片</span>
