...
class BespokesController extends Controller
{
    protected $model;
    protected $gl;
    public function __construct(Request $request){
        ...
        $this->showdata['nav'] = 'user_bespoke';
        $this->model = new UserBespoke();
        $this->gl = 'user_bespoke';
...
//        $xis = \App\Status_t::where('ty','=','9')->pluck('id','status_name');
        ...
        return view('admin.teacher.edit', compact('corp','showdata'));
    }
