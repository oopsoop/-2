...
//    }
    ...
    public function bindWxuser(Request $request){
        $is_setups = Wxuser::class->pluck('id','status_name');
        dd($is_setups);
    }
